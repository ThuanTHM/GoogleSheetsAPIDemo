...
public class CredentialsUtils {
    ...
    public static Credential getOAuth2Credentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = CredentialsUtils.class.getResourceAsStream(AUTH2_0_CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static HttpRequestInitializer getServiceAccountCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = CredentialsUtils.class.getResourceAsStream(SERVICE_ACCOUNTS_CREDENTIALS_FILE_PATH);
        if (in == null) {
